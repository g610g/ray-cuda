...
def identify_solid_bases_host(
    local_read, kmer_len, kmer_spectrum, solids, size, aux_kmer
):
...
def identify_trusted_regions_host(
    ...
    size = seq_len - kmer_len
    identify_solid_bases_host(
        local_reads, kmer_len, kmer_spectrum, solids, size, aux_kmer
    )
