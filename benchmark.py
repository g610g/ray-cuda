...
original = (
    "genetic-assets/final_data/ecoli_datasets/ecoli_30coverage_3perc_aligned_sorted.bam"
)
corrected = "genetic-assets/final_data/ecoli_datasets/ecoli_30coverage_3perc_musket_aligned_sorted.bam"
